 ...
 */
ComparisonFailure.prototype.toString = function()
{
 ...
 */
TestFailure.prototype.exceptionMessage = function()
{ 
 ...
 */
TestFailure.prototype.failedTest = function() { return this.mTest; }
/**
 * Test for a JsUnit failure.
 * @treturn Boolean Returns true if the exception is a failure.
 */
TestFailure.prototype.isFailure = function() 
{ 
 ...
 */
TestFailure.prototype.thrownException = function() { return this.mException; }
/**
 ...
 */
TestFailure.prototype.trace = function() 
{ 
    var ex = this.thrownException();
    if( ex && ex.mCallStack )
 ...
 * @tparam AssertionFailedError afe The thrown assertion failure.
 */
TestResult.prototype.addFailure = function( test, afe )
{
 ...
 * @type Number
 */
TestResult.prototype.errorCount = function() { return this.mErrors.length; }
/**
 * Retrieve the number of occurred failures.
 * @type Number
 */
TestResult.prototype.failureCount = function() { return this.mFailures.length; }
/**
 * Remove a listener.
 * @tparam TestListener listener The listener.
 */
 ...
 * @type Number
 */
TestResult.prototype.runCount = function() { return this.mRunTests; }
/**
 ...
 * @type Boolean
 */
TestResult.prototype.shouldStop = function() { return this.mStop; }
/**
 * A test starts.
 ...
 */
TestResult.prototype.stop = function() { this.mStop = 1; }
/**
 ...
 * @since 1.3
 */
Assert.prototype.assertMatches = function( msg, expected, actual )
{
    if( arguments.length == 2 )
    {
        actual = expected;
 ...
 */
Assert.prototype.assertFloatEquals = function( msg, expected, actual, tolerance)
{
 ...
 * actual one.
 */
Assert.prototype.assertNotSame = function( msg, expected, actual )
{
    if( arguments.length == 2 )
    {
        actual = expected;
 ...
 */
Assert.prototype.fail = function( msg, stack, usermsg )
{
 ...
 */
TestCase.prototype.countTestCases = function() { return 1; }
/**
 * Creates a default TestResult object.
 * @treturn TestResult Returns the new object.
 */
TestCase.prototype.createResult = function() { return new TestResult(); }
/**
 * Find a test by name.
 * @note This is an enhancement to JUnit 3.8
 * @tparam String testName The name of the searched test.
 ...
 */
TestCase.prototype.getName = function() { return this.mName; }
/**
 ...
 */
TestCase.prototype.setName = function( name ) { this.mName = name; }
/**
 ...
 */
TestSuite.prototype.getName = function() { return this.mName ? this.mName : ""; }
/**
 ...
 * @type Number
 */
TestSuite.prototype.testCount = function() { return this.mTests.length; }
/**
 ...
 */
TestDecorator.prototype.basicRun = function( result ) { this.mTest.run( result ); }
/**
 * Returns the number of the test cases.
 * @type Number.
 */
TestDecorator.prototype.countTestCases = function() { return this.mTest.countTestCases(); }
/** 
 * Returns the test if it matches the name. 
 * @tparam String name The searched test name.
 * @type Test
 */
TestDecorator.prototype.findTest = function( name ) { return this.mTest.findTest( name ); }
/** 
 * Returns name of the test.
 * @note This is an enhancement to JUnit 3.8
 * @type String
 */
TestDecorator.prototype.getName = function() { return this.mTest.getName(); }
/** 
 * Returns name the decorated test.
 * @note This is an enhancement to JUnit 3.8
 * @type Test
 */
TestDecorator.prototype.getTest = function() { return this.mTest; }
/**
 * Run the test.
 * @tparam TestResult result The test result.
 */
TestDecorator.prototype.run = function( result ) { this.basicRun( result ); }
/** 
 * Sets name of the test.
 * @tparam String name The new name of the test.
 */
TestDecorator.prototype.setName = function( name ) { this.mTest.setName( name ); }
/** 
 * Returns the test as string. 
 * @note This is an enhancement to JUnit 3.8
 * @type String
 */
TestDecorator.prototype.toString = function() { return this.mTest.toString(); }
 ...
 */
BaseTestRunner.prototype.addFailure = function( test, afe ) 
{ 
    this.testFailed( TestRunListener.prototype.STATUS_ERROR, 
 ...
 */
BaseTestRunner.prototype.getPreference = function( key, value ) 
{ 
 ...
 */
BaseTestRunner.prototype.getPreferences = function() 
{ 
 ...
 * clearStatus().
 */
BaseTestRunner.prototype.getTest = function( name ) 
{ 
 ...
 */
BaseTestRunner.prototype.setPreference = function( key, value ) 
{ 
 ...
 */
BaseTestRunner.prototype.setPreferences = function( prefs ) 
{ 
 ...
 */
BaseTestRunner.prototype.showStackRaw = function() 
{ 
 ...
 */
BaseTestRunner.prototype.truncate = function( str ) 
{
 ...
 * @tparam Error except The thrown error.
 */
ResultPrinter.prototype.addError = function( test, except )
{
 ...
 * @tparam AssertionFailedError afe The thrown failure.
 */
ResultPrinter.prototype.addFailure = function( test, afe )
{
 ...
 * @type String
 */
ResultPrinter.prototype.elapsedTimeAsString = function( runTime )
{
 ...
 */
ResultPrinter.prototype.endTest = function( test )
{
}
/**
 ...
 * @type PrinterWriter
 */
ResultPrinter.prototype.getWriter = function()
{
    return this.mWriter;
}
/**
 ...
 * @tparam Number runTime The elapsed time in ms.
 */
ResultPrinter.prototype.print = function( result, runTime )
{
 ...
 */
ResultPrinter.prototype.printDefect = function( defect, count )
{
 ...
 * \internal
 */
ResultPrinter.prototype.printDefectHeader = function( defect, count )
{
 ...
 */
ResultPrinter.prototype.printDefects = function( array, type )
{
    if( array.length == 0 )
        return;
    if( array.length == 1 )
 ...
 * \internal
 */
ResultPrinter.prototype.printDefectTrace = function( defect )
{
 ...
 * @tparam TestResult result The complete test result.
 */
ResultPrinter.prototype.printErrors = function( result )
{
 ...
 * @tparam TestResult result The complete test result.
 */
ResultPrinter.prototype.printFailures = function( result )
{
 ...
 * @tparam TestResult result The complete test result.
 */
ResultPrinter.prototype.printFooter = function( result )
{
 ...
 * @tparam Number runTime The elapsed time in ms.
 */
ResultPrinter.prototype.printHeader = function( runTime )
{
    var writer = this.getWriter();
    writer.println();
 ...
 * instance uses the SystemWriter.
 */
ResultPrinter.prototype.setWriter = function( writer )
{
 ...
 */
ResultPrinter.prototype.startTest = function( test )
{
 ...
 */
TextTestRunner.prototype.createTestResult = function() 
{
 ...
 * @since 1.3
 */
TextTestRunner.prototype.getPrinter = function()
{
 ...
 */
TextTestRunner.prototype.doRun = function( test ) 
{
 ...
 * @treturn TestResult The result of the test.
 */
TextTestRunner.prototype.run = function( test )
{
 ...
 * success.
 */
TextTestRunner.prototype.main = function( args )
{
    var ex;
 ...
 */
TextTestRunner.prototype.runFailed = function( msg )
{
 ...
 * @tparam Object outdev Output device
 */
TextTestRunner.prototype.setPrinter = function( outdev )
{
 ...
 */
ClassicResultPrinter.prototype.addError = function( test, except )
{
    var str = "";
 ...
 * @tparam Error except The thrown exception.
 */
ClassicResultPrinter.prototype.addFailure = function( test, except )
{
 ...
 * @tparam Test test The ended test.
 */
ClassicResultPrinter.prototype.endTest = function( test )
{
    if( test instanceof TestSuite )
    {
 ...
 */
ClassicResultPrinter.prototype.print = function( result, runTime )
{
 ...
 */
ClassicResultPrinter.prototype.printHeader = function( test )
{
    this.mRunTests = 0;
    this.mInReport = true;
    this.mNest = "";
 ...
 * @tparam Number runTime The elapsed time in ms.
 */
ClassicResultPrinter.prototype.printFooter = function( result, runTime )
{
 ...
 * @tparam Test test The started test.
 */
ClassicResultPrinter.prototype.startTest = function( test )
{
    if( !this.mInReport )
 ...
 */
ClassicResultPrinter.prototype.writeLn = function( str )
{
 ...
 * @tparam Error except The thrown error.
 */
XMLResultPrinter.prototype.addError = function( test, except )
{
 ...
 * @tparam AssertionFailedError afe The thrown failure.
 */
XMLResultPrinter.prototype.addFailure = function( test, afe )
{
 ...
 * @tparam Test test The test that ends.
 */
XMLResultPrinter.prototype.endTest = function( test )
{
 ...
 * @tparam Number runTime The elapsed time in ms.
 */
XMLResultPrinter.prototype.print = function( result, runTime )
{
    var writer = this.getWriter();
 ...
 * @tparam Test test The test that starts.
 */
XMLResultPrinter.prototype.startTest = function( test )
{
    if( this.mSuite == null )
 ...
 */
HTMLTestRunner.prototype.setPrinter = function( outdev )
{
 ...
 */
AllTestsCollector.prototype.collectTests = function() 
{
    var tests = new Array();
 ...
 */
GenericTestCollector.prototype.collectTests = function() 
{
    var tests = new Array();
 ...
 */
GenericTestCollector.prototype.isTest = function( testFunc ) 
{
 ...
 * @treturn TestResult Returns the new TestResult instance.
 */
EmbeddedTextTestRunner.prototype.createTestResult = function() 
{
    return new TestResult(); 
}
/**
 ...
 * @treturn TestResult The result of the test.
 */
EmbeddedTextTestRunner.prototype.run = function( testNames, suiteName ) 
{
    var result = this.createTestResult();
    result.addListener( this.mPrinter );
 ...
 */
EmbeddedTextTestRunner.prototype.setPrinter = function( printer )
{
