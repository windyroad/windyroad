 ...
 **/
JsUtil.prototype.getCaller = function( fn )
{
    switch( typeof( fn ))
    {
        case "undefined":
            return JsUtil.prototype.getCaller( JsUtil.prototype.getCaller );
 ...
 */
JsUtil.prototype.include = function( fname )
{
    var ret = "true";
 ...
 * @type SystemWriter
 */
JsUtil.prototype.getSystemWriter = function()
{
 ...
 */
JsUtil.prototype.quit = function( ret )
{
 ...
 * \internal
 */
CallStack.prototype._fill = function( depth )
{
    ...
    ++depth;
    var fn = JsUtil.prototype.getCaller( CallStack.prototype._fill );
 ...
 * @tparam Number depth Maximum recorded stack depth (defaults to 10).
 **/
CallStack.prototype.fill = function( depth )
{
    this.mStack = null;
    if( JsUtil.prototype.hasCallStackSupport )
        this._fill( depth );
 ...
 **/
CallStack.prototype.getStack = function()
{
    var a = new Array();
    if( this.mStack != null )
 ...
 */
PrinterWriter.prototype.close = function() 
{
    this.flush();
    this.mClosed = true;
}
 ...
 */
PrinterWriter.prototype.flush = function()
{
    if( !this.mClosed )
    {
 ...
 */
PrinterWriter.prototype.print = function( data )
{
    if( !this.mClosed )
    {
        var undef;
 ...
 */
PrinterWriter.prototype.println = function( data )
{
    this.print( data );
    this.flush();
}
 ...
 */
SystemWriter.prototype.close = function() 
{
    this.flush();
}
/** 
 * \internal 
 */
SystemWriter.prototype._flush = function( str ) 
{
    /* self-modifying code ... */
    if( JsUtil.prototype.isMozillaShell )
        this._flush = 
 ...
 * @type String
 */
StringWriter.prototype.get = function() 
{
    if( !this.mClosed )
        this.close();
    return this.mString;
 ...
 * \internal 
 */
StringWriter.prototype._flush = function( str )
{
    this.mString += str;
}
 ...
 * @type PrinterWriter
 */
HTMLWriterFilter.prototype.getWriter = function() 
{
    return this.mWriter;
}
/**
 ...
 */
HTMLWriterFilter.prototype.setWriter = function( writer ) 
{
 ...
 * \internal 
 */
HTMLWriterFilter.prototype._flush = function( str )
{
    str = str.toString();
    str = str.replace( /&/g, "&amp;" ); 
    str = str.replace( /</g, "&lt;" ); 
