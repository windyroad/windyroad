...
An AI agent deleted production in 9 seconds. The lesson is not AI safety. It is that the agent had production credentials in its environment. Same access pattern took down GitLab in 2017 and Pixar in 1998. The fix is structural: no production access for agents; pipeline actions are the boundary.
