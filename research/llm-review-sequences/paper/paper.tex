...
abstract policy families. Every program is synthetic, executes only in memory,
and has no network, file-system, credential, persistence, deployment, or
...
deterministic scanner rejects network, shell, subprocess, file-system,
package-install, credential, personal-data, persistence, destructive, dynamic
execution, and non-relative import features.
...
The systems are frozen as product configurations rather than interchangeable
...
\begin{tabular}{@{}lll@{}}
\toprule
System & Frozen client & Requested model \\
\midrule
...
category. Complete requests are at most 2,961 UTF-8 bytes. Schema-invalid
...
Subscription rate limits pause collection until the same plan window resets.
No API credit is accepted. A no-response infrastructure failure may be retried
after reset up to three times; every attempt remains in the ledger. Collection
...
detection-favourable and detection-unfavourable bounds assign missing malicious
and benign boundaries oppositely. A review-system-specific complete-pair
sensitivity drops a structural template only for the affected system. No
imputation model is fitted.

The sample is determined by subscription access, not an 80\% power target. Under
...
within $\pm0.10$, and power of 0.1016 for a 0.10 interaction. Consequently, null
...
\textbf{External validity.} Forty fixed templates, eight policy families, two
...
Three isolated subagents review the same frozen packet for benchmark safety,
methods, and reproducibility. Their raw reports and the author's resolution log
are archived. These records are labelled AI-assisted internal review, not
...
Material judged to provide reusable operational evasion guidance is withheld or
reduced to non-operational metadata, with every omission documented.

\section{Reproducibility}

The versioned package contains the generator, cards, prompts, schedule,
collection ledgers, scorer, power simulation, preregistration, internal-review
records, and analysis code. Candidate hashes are:

\begin{itemize}[leftmargin=1.5em]
  \item scenario cards:
  \code{2560903620dd2a33ed54f0169627201c6638efeb673b7c640c0682331854b17b};
  \item rendered prompts:
  \code{f4cd74021cfdcd67b50f0a88b05f881e5323eb5acb9364cc04339f0e68e6ed08};
  \item randomised schedule:
  \code{e704e82c8c052cd05fdef8e2d19e8551e07617c537d81b52872d829d7e37ad1a};
  \item blinded call ledger:
  \code{9d18f204da53f3a3db860c6bc1134e219c4db1ed171d672d667f2d1b577c0f27};
  \item ground-truth ledger:
  \code{f0b3ad9646dc29ed6d6dea350dbc3c33fe25c1c3ec924d453680810e740950bb}.
\end{itemize}
