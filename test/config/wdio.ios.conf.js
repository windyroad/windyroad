...
exports.config = {
  ...
  // Let's say you have 3 different capabilities (Chrome, Firefox, and Safari)
  // and you have set maxInstances to 1; wdio will spawn 3 processes. Therefore,
  // if you have 10 spec files and you set maxInstances to 10, all spec files will
  ...
  // of your baseUrl. If your `url` parameter starts without a scheme or `/` (like
  ...
  // with the test process in order to enhance it and to build services around it.
  // You can either apply a single function or an array of methods to it. If one
  // of them returns with a promise, WebdriverIO will wait until that promise got
