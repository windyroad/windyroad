...
- **Reported upstream**: https://github.com/windyroad/agent-plugins/issues/296 (2026-06-27)
...
- **Upstream issue status**: filed 2026-06-27 as windyroad/agent-plugins#296 (https://github.com/windyroad/agent-plugins/issues/296) via `/wr-itil:report-upstream`, classified problem-report per ADR-033 primary classifier. Matched the upstream `problem-report.yml` template; both external-comms gates (risk + voice-tone) returned PASS on the drafted body. Same shape as P042 / P049 / P060 / P073.
...
- **URL**: https://github.com/windyroad/agent-plugins/issues/296
- **Reported**: 2026-06-27
- **Template used**: problem-report.yml
- **Disclosure path**: public issue
- **Cross-reference confirmed**: yes (issue body records the downstream P048 reference)
