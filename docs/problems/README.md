...
> Last reviewed: 2026-04-25 (full WSJF re-scoring; 10 tickets auto-transitioned Open to Known Error: P009, P010, P011, P012, P013, P014, P015, P016, P017, P018; Effort + WSJF lines added to all 14 actionable tickets per the manage-problem skill).
...
| 16.0 | P016 | Filter drops significant stories without corroboration | 16 (High) | Known Error | M |
...
- **P016 and P018**: form the Friday-pressure cluster. P016 fixes filter logic that drops significant stories; P018 splits the pipeline into prep + finalise phases to reduce Friday concentration.
