...
Records ADR-055 (GitHub Actions are pinned by owner, and permissions are declared per workflow), which ships `human-oversight: unconfirmed` for the maintainer to drain.
