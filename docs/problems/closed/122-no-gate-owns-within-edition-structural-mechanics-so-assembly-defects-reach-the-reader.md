...
### 6. Decision record: two amendments plus one new ADR

> **Corrected 2026-08-07.** This section originally read "three amendments, no new ADR". Tom directed that a new decision gets its own document, because a reader who opens an ADR reads the main decision and can miss an amendment section. The skip rule is therefore **ADR-046 (Skip the agent re-invocation when the artefact is unchanged)**, not an ADR-043 clause. Every reference below to a "sixth clause" on ADR-043 is superseded by that.
