...
- `SKILL.md` describes this rule rather than the one it replaces: the preamble, step 15.37's exit condition, step 15.4, step 16's save blocks and step 17's summary. **Done 2026-08-10**, together with the two LinkedIn surfaces at 15.55 and 15.57 and the phase carry-forward at 15.37-prime, which the original criterion missed. A prep-time blocking finding is now still blocking at finalise rather than decaying across the phase boundary, which is the per-edition accumulation this decision exists to stop.
