...
## Structural invariants (P089, enforced by check-newsletter-structure.sh)

These six are checked deterministically at save (step 16 runs `scripts/check-newsletter-structure.sh`). Produce them by construction so the lint passes first time:
