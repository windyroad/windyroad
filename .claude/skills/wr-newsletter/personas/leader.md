...
Team voice ("we") for the publication's work and reporting. "I" is for Tom's explicit judgement calls, in the "From Tom" opener, in the standing provenance line, and in item analysis and commentary. Not in the factual "What happened" bullets and not in the move list, which report and instruct rather than judge (ADR 032 element 5, first person on both the brief and the LinkedIn companion). The full rule and its test are in `docs/VOICE-AND-TONE.md` under "Who is speaking". This was widened on 2026-08-24. The previous wording confined "I" to the opener and the provenance line, which two consecutive editions published past: Issue 18 carries "here is where I come down" in an item body, and Issue 19 carries three judgement calls outside those two places. The addendum was describing a practice that had already changed. The locations are enumerated rather than left open so the rule stays checkable. Direct, specific, governance-oriented. Frame items as conditions in the industry, not as judgements of the reader's team (ADR 015). Patch-fitness vocabulary is welcome ("dependency staleness", "patch cycle", "review pipeline"). Avoid pure dev-craft jargon (compile-time, monad, type variance) unless the item is unambiguously about that. Prefer plain words over obscure ones in this register: "probably made up" over "apocryphal", "made up" over "fabricated".
